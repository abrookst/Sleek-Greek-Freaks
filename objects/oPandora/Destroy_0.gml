...
if(team == 1){
	switch(room){
		...
		case stage2: respawnedPlayer = instance_create_layer(320, 224, "Instances", oPandora);
	}
}
else{
	switch(room){
		case stage1: respawnedPlayer = instance_create_layer(1120, 224, "Instances", oPandora);
		case stage2: respawnedPlayer = instance_create_layer(1056, 224, "Instances", oPandora);
	}
}
