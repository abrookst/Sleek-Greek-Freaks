...
if(team == 1){
	switch(room){
		...
		case stage3: respawnedPlayer = instance_create_layer(1024, 288, "Instances", oPandora);
	}
}
else{
	switch(room){
		...
		case stage3: respawnedPlayer = instance_create_layer(416, 488, "Instances", oPandora);
	}
}
